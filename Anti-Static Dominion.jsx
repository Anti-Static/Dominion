...
var palette = (panelGlobal instanceof Panel) ? panelGlobal : new Window("palette");
    ...
    palette.preferredSize.width = 276;
...
var OrientationDropDown = group3.add("dropdownlist", undefined, undefined, {name: "OrientationDropDown", items: OrientationDropDown_array});
    OrientationDropDown.selection = 1;
...
var AutoSizeChildrenCheckbox = panel2.add("checkbox", undefined, undefined, {name: "AutoSizeChildrenCheckbox"});
    AutoSizeChildrenCheckbox.text = "Auto-Size Children";

var PrioritizeCenterCheckbox = panel2.add("checkbox", undefined, undefined, {name: "PrioritizeCenterCheckbox"});
    PrioritizeCenterCheckbox.text = "Prioritize Center";

var InheritRoundnessCheckbox = panel2.add("checkbox", undefined, undefined, {name: "InheritRoundnessCheckbox"});
...
var CreateWindowButton = ButtonGroup1.add("button", undefined, undefined, {name: "CreateWindowButton"});
...
var GetParentButton = panel3.add("image", undefined, File.decode(GetParentButton_imgString), {name: "GetParentButton"});
...
var GetChildrenButton = panel3.add("image", undefined, File.decode(GetChildrenButton_imgString), {name: "GetChildrenButton"});
...
var GetSiblingsButton = panel3.add("image", undefined, File.decode(GetSiblingsButton_imgString), {name: "GetSiblingsButton"});
...
var GetMatteButton = panel3.add("image", undefined, File.decode(GetMatteButton_imgString), {name: "GetMatteButton"});
...
// NULLBUTTONGROUP
// ===============
var NullButtonGroup = panel4.add("group", undefined, {name: "NullButtonGroup"});
    ...
    NullButtonGroup.alignment = ["fill","top"];

// NULLBUTTONGROUP1
// ================
var NullButtonGroup1 = NullButtonGroup.add("group", undefined, {name: "NullButtonGroup1"});
...
// GROUP5
// ======
var group5 = NullButtonGroup1.add("group", undefined, {name: "group5"});
...
var TLNullButton = group5.add("image", undefined, File.decode(TLNullButton_imgString), {name: "TLNullButton"});
...
var TCNullButton = group5.add("image", undefined, File.decode(TCNullButton_imgString), {name: "TCNullButton"});
...
var TRNullButton = group5.add("image", undefined, File.decode(TRNullButton_imgString), {name: "TRNullButton"});

// GROUP6
// ======
var group6 = NullButtonGroup1.add("group", undefined, {name: "group6"});
...
var CLNullButton = group6.add("image", undefined, File.decode(CLNullButton_imgString), {name: "CLNullButton"});
...
var CNullButton = group6.add("image", undefined, File.decode(CNullButton_imgString), {name: "CNullButton"});
...
var CRNullButton = group6.add("image", undefined, File.decode(CRNullButton_imgString), {name: "CRNullButton"});

// GROUP7
// ======
var group7 = NullButtonGroup1.add("group", undefined, {name: "group7"});
...
var BLNullButton = group7.add("image", undefined, File.decode(BLNullButton_imgString), {name: "BLNullButton"});
...
var BCNullButton = group7.add("image", undefined, File.decode(BCNullButton_imgString), {name: "BCNullButton"});
...
var BRNullButton = group7.add("image", undefined, File.decode(BRNullButton_imgString), {name: "BRNullButton"});

// NULLBUTTONGROUP2
// ================
var NullButtonGroup2 = NullButtonGroup.add("group", undefined, {name: "NullButtonGroup2"});
...
var CornerNullButton = NullButtonGroup2.add("image", undefined, File.decode(CornerNullButton_imgString), {name: "CornerNullButton"});

// OFFESTGROUP
// ===========
var OffestGroup = panel4.add("group", undefined, {name: "OffestGroup"});
    OffestGroup.orientation = "column";
    OffestGroup.alignChildren = ["fill","center"];
    OffestGroup.spacing = 0;
    OffestGroup.margins = 0;
    OffestGroup.alignment = ["fill","top"];

// XOFFSETGROUP
// ============
var XOffsetGroup = OffestGroup.add("group", undefined, {name: "XOffsetGroup"});
...
// GROUP8
// ======
var group8 = XOffsetGroup.add("group", undefined, {name: "group8"});
...
// GROUP9
// ======
var group9 = XOffsetGroup.add("group", undefined, {name: "group9"});
    group9.orientation = "column";
    group9.alignChildren = ["left","center"];
    group9.spacing = 5;
    group9.margins = 0;

var insetSlider = group9.add("slider", undefined, undefined, undefined, undefined, {name: "insetSlider"});
...
// GROUP10
// =======
var group10 = XOffsetGroup.add("group", undefined, {name: "group10"});
...
// NULLLABELGROUP
// ==============
var NullLabelGroup = panel4.add("group", undefined, {name: "NullLabelGroup"});
    NullLabelGroup.orientation = "row";
    NullLabelGroup.alignChildren = ["left","center"];
    NullLabelGroup.spacing = 10;
    NullLabelGroup.margins = 0;
    NullLabelGroup.alignment = ["fill","top"];

// GROUP11
// =======
var group11 = NullLabelGroup.add("group", undefined, {name: "group11"});
...
var nullLabelDropDown = NullLabelGroup.add("dropdownlist", undefined, undefined, {name: "nullLabelDropDown", items: nullLabelDropDown_array});
    nullLabelDropDown.selection = 9;
    nullLabelDropDown.preferredSize.width = 124;

// PANEL5
// ======
var panel5 = group4.add("panel", undefined, undefined, {name: "panel5"});
    panel5.text = "CORNERS";
...
var createCornersButton = group12.add("button", undefined, undefined, {name: "createCornersButton"});
    createCornersButton.text = "Corners";
    createCornersButton.preferredSize.height = 35;
    createCornersButton.alignment = ["left","fill"];

var createEdgesButton = group12.add("button", undefined, undefined, {name: "createEdgesButton"});
    createEdgesButton.text = "Edges";
    createEdgesButton.preferredSize.height = 35;
    createEdgesButton.alignment = ["left","fill"];

// PANEL6
// ======
var panel6 = group4.add("panel", undefined, undefined, {name: "panel6"});
    panel6.text = "TEXTURE";
...
var AspectCheckbox = panel6.add("checkbox", undefined, undefined, {name: "AspectCheckbox"});
    AspectCheckbox.text = "Maintain Aspect Ratio";

var textureFitToWindowButton = panel6.add("button", undefined, undefined, {name: "textureFitToWindowButton"});
...
// PANEL7
// ======
var panel7 = group4.add("panel", undefined, undefined, {name: "panel7"});
    panel7.text = "MATTE";
...
// MATTELABELGROUP
// ===============
var MatteLabelGroup = panel7.add("group", undefined, {name: "MatteLabelGroup"});
    ...
    MatteLabelGroup.alignment = ["fill","top"];

// GROUP13
// =======
var group13 = MatteLabelGroup.add("group", undefined, {name: "group13"});
    group13.preferredSize.width = 85;
    group13.orientation = "row";
    group13.alignChildren = ["left","center"];
    group13.spacing = 10;
    group13.margins = 0;

var statictext6 = group13.add("statictext", undefined, undefined, {name: "statictext6"});
...
var matteLabelDropDown = MatteLabelGroup.add("dropdownlist", undefined, undefined, {name: "matteLabelDropDown", items: matteLabelDropDown_array});
    matteLabelDropDown.selection = 2;
    matteLabelDropDown.preferredSize.width = 124;

// PANEL7
// ======
var CreateMatteButton = panel7.add("button", undefined, undefined, {name: "CreateMatteButton"});
...
// PANEL8
// ======
var panel8 = group4.add("panel", undefined, undefined, {name: "panel8"});
    panel8.text = "GRADIENT";
    panel8.orientation = "column";
    panel8.alignChildren = ["left","top"];
    panel8.spacing = 2;
    panel8.margins = 10;
    panel8.alignment = ["fill","center"];

// GROUP14
// =======
var group14 = panel8.add("group", undefined, {name: "group14"});
    group14.orientation = "row";
    group14.alignChildren = ["left","center"];
    group14.spacing = 8;
    group14.margins = 0;
    group14.alignment = ["fill","top"];
...
var CreateGradientVButton = group14.add("image", undefined, File.decode(CreateGradientVButton_imgString), {name: "CreateGradientVButton"});
...
var CreateGradientHButton = group14.add("image", undefined, File.decode(CreateGradientHButton_imgString), {name: "CreateGradientHButton"});
...
var CreateGradientD1Button = group14.add("image", undefined, File.decode(CreateGradientD1Button_imgString), {name: "CreateGradientD1Button"});
...
var CreateGradientD2Button = group14.add("image", undefined, File.decode(CreateGradientD2Button_imgString), {name: "CreateGradientD2Button"});
...
var CreateGradientRButton = group14.add("image", undefined, File.decode(CreateGradientRButton_imgString), {name: "CreateGradientRButton"});
...
// GROUP15
// =======
var group15 = tab3.add("group", undefined, {name: "group15"});
    group15.preferredSize.width = 242;
...
var scriptName = group15.add("statictext", undefined, undefined, {name: "scriptName"});
    scriptName.text = "Dominion";
    scriptName.alignment = ["fill","center"];

var YouTubeButton = group15.add("button", undefined, undefined, {name: "YouTubeButton"});
    YouTubeButton.text = "youtube.com/@Anti-StaticTV";
    YouTubeButton.alignment = ["fill","center"];

var statictext7 = group15.add("statictext", undefined, undefined, {name: "statictext7", multiline: true});
...
var image2 = group15.add("image", undefined, File.decode(image2_imgString), {name: "image2"});

var statictext8 = group15.add("statictext", undefined, undefined, {name: "statictext8", multiline: true});
    statictext8.text = "This work is licensed under a Creative Commons Attribution-ShareAlike 4.0 International License.";

var statictext9 = group15.add("statictext", undefined, undefined, {name: "statictext9", multiline: true});
...
createCornersButton.onClick = function() {
    app.beginUndoGroup("Dominion : Create Corners");
    createCorners();
    app.endUndoGroup();
}

createEdgesButton.onClick = function() {
    app.beginUndoGroup("Dominion : Create Edges");
    createEdges();
    app.endUndoGroup();
}
			...
			for (var i = 0; i < sLayers.length; i++) {
				...
				if (isDominion(cl)) {
					...
					if (tt != null) {
						...
						nt.selected = false;
						nt.transform.rotation.setValue(rt*90);
					}
					n.moveBefore(cl);
					n.selected = false;
					cl.selected = true;
...
function createCorners() {
	if (app.project.activeItem.selectedLayers.length > 0) {
        ...
        for (var i = 0; i < sLayers.length; i++) {
			var cl = sLayers[i];
			if (isDominion(cl)) {
				if (cl.property("Contents").canAddProperty("ADBE Vector Group")) {
                    var sizeSlider = cl.Effects.addProperty("ADBE Slider Control");
                	sizeSlider.name = "Corner Size";
                	sizeSlider.property(1).setValue(10);

                    var colorControl = cl.Effects.addProperty("ADBE Color Control");
                	colorControl.name = "Corner Color";

					var cGroup = cl.property("Contents").addProperty("ADBE Vector Group");
					cGroup.name = "Corner Group";
                    var cString = 'var s = content("Window").content("Window Rect").size;\rvar p = content("Window").content("Window Rect").position;\rvar id = thisProperty.propertyGroup(1).propertyIndex;\r';
                    var sString = 'var s = effect("Corner Size")("' + localSliderObj[languageString] + '");\r[s, s]';
                    var coString = 'var c = effect("Corner Color")("' + localColorObj[languageString] + '");\rc';
					for (var x = 1; x <= 4; x++) {
                        if(x==1){
                            cString+='p+[0,0];';
                        }else if(x==2){
						...
						var c = cGroup.property("Contents").addProperty("ADBE Vector Shape - Rect");
                        //var cp = c.property("Contents").addProperty("Rectangle Path 1");
                        c.name = "Corner "+x;
                        c.property("Size").expression = sString;
                        c.property("Position").expression = cString;
					}
                    var s = cGroup.property("Contents").addProperty("ADBE Vector Graphic - Stroke");
                    s.property("Color").expression = coString;
	...
	if (app.project.activeItem.selectedLayers.length > 0) {
        ...
        for (var i = 0; i < sLayers.length; i++) {
			...
			if (isDominion(cl)) {
				if (cl.property("Contents").canAddProperty("ADBE Vector Group")) {
                    var sizeSlider = cl.Effects.addProperty("ADBE Slider Control");
                	sizeSlider.name = "Edge Size";
                	sizeSlider.property(1).setValue(10);

                    var colorControl = cl.Effects.addProperty("ADBE Color Control");
                	colorControl.name = "Edge Color";

					var cGroup = cl.property("Contents").addProperty("ADBE Vector Group");
					cGroup.name = "Edge Group";
                    var cString = 'var s = content("Window").content("Window Rect").size;\rvar p = content("Window").content("Window Rect").position;\rvar id = thisProperty.propertyGroup(1).propertyIndex;\r';
                    var sString = 'var s = effect("Edge Size")("' + localSliderObj[languageString] + '");\r[s, s]';
                    var coString = 'var c = effect("Edge Color")("' + localColorObj[languageString] + '");\rc';
					for (var x = 1; x <= 4; x++) {
                        if(x==1){
                            cString+='p+[s[0]/2,0];';
                        }else if(x==2){
